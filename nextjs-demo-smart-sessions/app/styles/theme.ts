...
export const bearishTheme = {
  negative: "#FF4E17", // orange primary
  hover: "#FF6B3F", // lighter orange
  glow: "rgba(255,78,23,0.5)",
  background: "rgba(154,52,18,0.9)" // darker orange with opacity
}
...
export const candlestickSeriesOptions: DeepPartial<CandlestickSeriesOptions> = {
  ...
  downColor: "#FF4E17", // Update to orange
  borderUpColor: "#4ADE80", // Neon green
  borderDownColor: "#FF4E17", // Update to orange
  wickUpColor: "#4ADE80", // Neon green
  wickDownColor: "#FF4E17" // Update to orange
}
